...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const animateStats = () => {
    ...
    const animate = () => {
      ...
      setCountedStats({
        ...
        support: currentStep === steps ? targetValues.support : `${Math.floor(24 * easeOutQuart)}/${Math.floor(7 * easeOutQuart)}`,
      });
  ...
  const stats = [
    { icon: Users, value: `${countedStats.clients}+`, label: 'Happy Clients', color: 'from-blue-400 to-cyan-400' },
    { icon: Award, value: `${countedStats.projects}+`, label: 'Projects Delivered', color: 'from-cyan-400 to-blue-400' },
    { icon: TrendingUp, value: `${countedStats.countries}+`, label: 'Countries Served', color: 'from-blue-500 to-purple-500' },
    { icon: Zap, value: countedStats.support, label: 'Support Available', color: 'from-purple-400 to-pink-400' },
  ];
  ...
  const features = [
    ...
    {
      title: 'Expert Team',
      description: 'Our team of experienced developers and designers bring years of expertise to every project.',
      icon: '👥',
    },
    {
    ...
    },
    {
      ...
      description: 'Build applications that grow with your business, from startup to enterprise scale.',
      icon: '📈',
    },
    {
  ...
  return (
    <div>
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="bg-gradient-to-b from-black via-blue-950 to-black py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Achievements</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  <div className={`inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-r ${stat.color} mb-4 group-hover:shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110`}>
                    <Icon size={28} className="text-white" />
                  </div>
                  <div className={`text-4xl md:text-5xl font-bold bg-gradient-to-r ${stat.color} bg-clip-text text-transparent mb-2 tabular-nums`}>
                    {stat.value}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Vedseem</span>
            </h2>
...
{/*when Startup loader fades a white screen appears and then hero section appears but i want landing page to load and startup loader acts as a loader to give landing page time to load 

in AnimatedProjects.tsx , the bar getting color filled isnt smooth so pls make it smooth and redesign it pls */}