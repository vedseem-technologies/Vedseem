...
const SERVICES = [
  {
    ...
    description:
      "High-performance, scalable websites and web applications tailored to your business goals. We build with modern frameworks for speed and SEO.",
    features: [
  ...
  },
  {
    ...
    description:
      "Native and cross-platform mobile apps that provide seamless user experiences. We turn your ideas into powerful apps for iOS and Android.",
    features: [
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "User-centric designs that blend aesthetics with functionality. We create intuitive interfaces that engage users and drive conversions.",
    features: [
  ...
  },
  {
    ...
    description:
      "Robust server-side solutions that power your applications. We ensure security, speed, and reliability for your data and logic.",
    features: [
  ...
  },
  {
    ...
    description:
      "Secure and scalable cloud infrastructure to keep your applications running smoothly. We handle deployment, scaling, and monitoring.",
    features: [
  ...
  },
  {
    ...
    description:
      "Strategic digital marketing solutions that drive growth and maximize ROI. We help you reach your target audience and convert them into loyal customers.",
    features: [
    ...
    icon: <Megaphone className="size-8 text-purple-400" />,
  },
];
...
const PROCESS = [
  {
    ...
    title: "Discovery",
    description:
      "We start by understanding your vision, goals, and target audience to lay a solid foundation.",
  },
  {
    step: "02",
    title: "Strategy & Design",
    description:
      "We create a roadmap and design intuitive interfaces that align with your brand identity.",
  },
  {
    step: "03",
    title: "Development",
    description:
      "Our engineers build your solution using cutting-edge technologies and best coding practices.",
  },
  {
    step: "04",
    title: "Testing",
    description:
      "Rigorous testing ensures your product is bug-free, secure, and ready for the real world.",
  },
  {
    step: "05",
    title: "Launch & Support",
    description:
      "We help you launch successfully and provide ongoing support to ensure continued growth.",
  },
];
...
export default function Services() {
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-500/30">
      ...
      {/* Hero Section */}
      <section
        className="relative min-h-screen flex justify-center items-center pt-40 pb-20 z-10 px-4 sm:px-6 lg:px-8"
        style={{
          ...
          >
            ...
            <Reveal delay={0.2} width="100%">
              <p className="text-gray-200 max-w-2xl mx-auto text-lg md:text-xl font-medium mb-10 drop-shadow-md">
                We transform ideas into powerful digital realities. From web &
                mobile apps to complex backend systems, we deliver engineering
      ...
      <section className="relative py-24 z-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#050505] to-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <Reveal delay={0.1} width="100%">
              <p className="text-gray-400">
                We build with the best tools in the industry to ensure modern,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {TECHNOLOGIES.map((tech, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <h3 className="text-lg font-bold mb-6 text-blue-300 pb-2 border-b border-white/10">
                  {tech.category}
                </h3>
                <div className="flex flex-wrap gap-3">
                  {tech.items.map((item, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1.5 rounded-lg bg-white/5 text-sm text-gray-300 hover:bg-white/10 transition-colors"
                    >
                      {item}
                    </span>
                  ))}
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                We don't just write code; we build partnerships. Our mission is
                to help you succeed by delivering digital products that make a
                real impact.
              </p>
            </Reveal>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Reveal delay={0.1} width="100%">
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
              ...
              life. No commitment, just a friendly chat.
            </p>
          </Reveal>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <a
              href="/contact"
              className="px-10 py-5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold text-lg rounded-full shadow-lg shadow-blue-900/40 hover:shadow-blue-700/60 transition-all"
            >
              Start Your Project
            </a>
          </motion.div>
